...
<head>
    ...
    <title>Edit Menu - Zarali's Catering Admin</title>
    <!-- Bootstrap 5 CSS -->
...
<body class="admin-body">
    ...
    <main class="admin-main mt-5 mt-md-0 pb-5">
        ...
        <div class="container-fluid max-w-4xl mx-auto px-0" id="editFormWrapper">
            ...
            <div class="mb-4">
                <div class="d-flex align-items-center gap-2 mb-1">
                    ...
                    <h2 class="fs-3 fw-bold text-dark tracking-tight mb-0"
                        style="font-family: 'Outfit', sans-serif; color: #2D6A4F !important;" id="editFormTitle">
                        Edit Produk
                    </h2>
                </div>
                <p class="text-muted ms-5 mb-0" style="font-size: 0.9rem;">
                    Perbarui informasi, harga, dan gambar produk.
                </p>
            </div>
            ...
            <!-- STATE: LOADING        -->
            <!-- ===================== -->
            <div id="editLoadingState" class="content-card p-5 text-center">
                <div class="spinner-border text-primary mb-3" role="status" style="color: #2D6A4F !important;">
                    <span class="visually-hidden">Memuat...</span>
                </div>
                <p class="text-muted mb-0">Memuat data produk...</p>
            </div>

            <!-- ===================== -->
            <!-- STATE: ERROR          -->
            <!-- ===================== -->
            <div id="editErrorState" class="content-card p-5 text-center d-none">
            ...
            <div id="editFormContent" class="d-none">
                ...
                <div class="content-card h-auto p-0 d-flex flex-column mb-4">
                            ...
                            <div class="row g-4 g-lg-5">
                                ...
                                <div class="col-lg-5">
                                    <div class="d-flex justify-content-between align-items-end mb-2">
                                        <label class="form-label mb-0">Galeri Foto Produk</label>
                                        <span class="text-muted small">Maks 4 foto</span>
                                    </div>

                                    <!-- Container gambar dari DB + gambar baru yang diupload -->
                                    <div class="row g-2 mb-3" id="galleryPreviewContainer">
                                        <!-- Diisi oleh JavaScript -->
                                    </div>

                                    <!-- Area tambah foto baru -->
                                    <div class="image-upload-area"
                                        style="min-height: 120px; padding: 1rem; height: auto;">
                                        <span class="material-symbols-outlined text-primary-custom mb-1"
                                            style="font-size: 2rem;">add_photo_alternate</span>
                                        <p class="fw-semibold text-dark mb-0" style="font-size: 0.8rem;">Tambah Foto
                                            Lain</p>
                                        <p class="text-muted mb-0" style="font-size: 0.7rem;">PNG, JPG up to 5MB</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="category">
                                                ...
                                                <option value="kue_satuan">Kue Satuan</option>
                                                <option value="paket_besar">Paket Besar</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control border-start-0 ps-0" id="price"
                                                    placeholder="0" min="0">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="description" rows="5"
                                                placeholder="Jelaskan detail rasa, bahan utama, atau keunggulan menu ini..."></textarea>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="status-card d-flex justify-content-between align-items-center">
                                                <div>
                                                    <h4 class="form-label mb-1">Status Menu Aktif</h4>
                                                    <p class="text-muted small mb-0">Menu akan langsung terlihat
                                                        oleh pelanggan jika diaktifkan.</p>
                                                </div>
                    ...
                    <div class="p-4 border-top bg-light bg-opacity-50 d-flex justify-content-end gap-3 align-items-center"
                        ...
                        <button type="button"
                            class="btn btn-outline-danger fw-semibold px-4 me-auto d-flex align-items-center gap-2"
                            id="btnHapusEdit">
    ...
    <script src="../js/admin/admin-menu.js?v=2"></script>
</body>
